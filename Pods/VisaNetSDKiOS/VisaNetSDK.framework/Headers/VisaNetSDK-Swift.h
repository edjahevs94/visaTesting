...
typedef SWIFT_ENUM(NSInteger, CEHeaderType, closed) {
  CEHeaderTypeLogo = 0,
  CEHeaderTypeText = 1,
  CEHeaderTypeNone = 2,
};
...
typedef SWIFT_ENUM(NSInteger, ExpirationDateFieldType, closed) {
  ExpirationDateFieldTypeDropDown = 1,
  ExpirationDateFieldTypeTextField = 2,
};

typedef SWIFT_ENUM(NSInteger, ExpirationDateType, closed) {
...
typedef SWIFT_ENUM(NSInteger, HeaderLogoType, closed) {
...
typedef SWIFT_ENUM(NSInteger, ServerLog, closed) {
  ServerLogEnabled = 0,
  ServerLogDisable = 1,
};
